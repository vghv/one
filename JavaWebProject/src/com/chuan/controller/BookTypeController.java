...
import com.chuan.controller.BaseController;
import com.chuan.pojo.BookType;
import com.chuan.service.BookTypeService;
import com.chuan.utils.ExportExcelUtil;
import com.chuan.utils.UserException;
...
public class BookTypeController extends BaseController {
	...
	public void add(@Validated BookType bookType, BindingResult br, Model model, HttpServletRequest request,
	...
	public void list(Integer page, Integer rows, Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		if (page == null || page == 0)
			page = 1;
		if (rows != 0)
			bookTypeService.setRows(rows);
	...
	public String frontshow(@PathVariable Integer bookTypeId, Model model, HttpServletRequest request)
			throws Exception {
	...
	public void update(@PathVariable Integer bookTypeId, Model model, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		/* 根据主键bookTypeId获取BookType对象 */
		BookType bookType = bookTypeService.getBookType(bookTypeId);
	...
	public void update(@Validated BookType bookType, BindingResult br, Model model, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		String message = "";
		boolean success = false;
		if (br.hasErrors()) {
	...
	public String delete(@PathVariable Integer bookTypeId, HttpServletRequest request)
	...
	public void delete(String bookTypeIds, HttpServletRequest request, HttpServletResponse response)
	...
	public void OutToExcel(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		for (int i = 0; i < bookTypeList.size(); i++) {
			...
			dataset.add(new String[] { bookType.getBookTypeId() + "", bookType.getBookTypeName(),
					bookType.getDays() + "" });
		}
		/*
